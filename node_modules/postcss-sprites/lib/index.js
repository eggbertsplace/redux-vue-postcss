...
function prepareFilterBy(opts) {
	...
	opts.filterBy.unshift(function (image) {
		return _fsExtra2.default.statAsync(image.path);
	});
}
	...
	return new _bluebird2.default(function (resolve, reject) {
		root.walkDecls(/^background(-image)?$/, function (decl) {
			...
			var url = undefined,
			    image = undefined,
			    color = undefined,
			    backgroundColorDecl = undefined,
			    commentDecl = undefined;
	...
	return new _bluebird2.default(function (resolve, reject) {
		...
		var promises = _lodash2.default.chain(images).groupBy(function (image) {
			...
			if (areRetinaImages(images)) {
				ratio = _lodash2.default.chain(images).flatten('ratio').uniq().head().value();
